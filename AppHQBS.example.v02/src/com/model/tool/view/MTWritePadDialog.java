...
public class MTWritePadDialog extends Dialog {

	Context context;
	LayoutParams p;
	MTDialogListener dialogListener;
	private int dWidth;
	private int dHeigh;

	public MTWritePadDialog(Context context, MTDialogListener dialogListener,
			int dwidth, int dHeigth) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_write_pad);
