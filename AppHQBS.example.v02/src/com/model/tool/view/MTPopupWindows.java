...
import com.model.tool.view.MTKCalendar.OnCalendarClickListener;
import com.model.tool.view.MTKCalendar.OnCalendarDateChangedListener;


@SuppressLint("ViewConstructor")
public class MTPopupWindows extends PopupWindow {
	private String date;

	@SuppressWarnings("deprecation")
	public MTPopupWindows(Context mContext, View parent,final EditText et) {

		View view = View.inflate(mContext, R.layout.act_popupwindow_calendar,
				null);
		...
		final MTKCalendar calendar = (MTKCalendar) view
